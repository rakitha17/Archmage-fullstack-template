...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    ...
    navigationbar_1: Attribute.Component<'layout.navbar1'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    navigationbar_2: Attribute.Component<'layout.navbar2'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    footerbar: Attribute.Component<'layout.footerbar'> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
  ...
  attributes: {
    ...
    contentSections: Attribute.DynamicZone<
      [
        ...
        'sections.features-section1',
        'sections.gallery-component1',
        'sections.gallery-component2',
        'sections.text-media',
        'sections.carousel',
        'sections.services',
        'sections.advertising',
        'sections.text-media1'
      ]
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
